...
public class RequestLogFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        doLog("contentLength", request.getContentLengthLong());
        ...
        doLog("------------------ Before doFilter - end", "------------------------------");

        // Perform the request
        chain.doFilter(request, response);

        // Log post-service information
        doLog("------------------ After doFilter - start", "------------------------------");
        ...
        if (hResponse == null) {
            ...
            doLog(">>> Response headers:", getTimestamp());
    ...
    private void doLog(String attribute, Object value) {
